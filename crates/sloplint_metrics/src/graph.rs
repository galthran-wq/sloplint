...
mod analysis;
mod coupling;
pub use coupling::{abstractness, concentration, distance, instability, Concentration};

mod resolve;
use resolve::candidates;
pub use resolve::{
    module_from_path, package_of, relative_anchor, resolve_internal, scan_module_imports,
};
