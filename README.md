...
(`SLP001/002/003/040/060`) are preview — enable with `--preview`. `SLP003` flags the
"comment deodorant" smell — dense comments over a high-cognitive-complexity function
(thresholds `comment_deodorant_density` / `comment_deodorant_cognitive` under `[limits]`).
