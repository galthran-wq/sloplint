...
(`SLP001/002/040/060/100`) are preview — enable with `--preview`. `SLP100` flags leftover
template placeholders (`your_api_key_here`, `# Insert your code here`); extend its lexicon
with `[placeholders] extra = [...]` in `sloplint.toml`.
